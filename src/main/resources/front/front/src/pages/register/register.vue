<template>
	...
	<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20231129/5956bf04b79948d7ad097c4c25324aef.png)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"flex-end"}'>
        <el-form class='rgs-form' v-if="pageFlag=='security1'" :style='{"padding":"20px 20px 20px 300px","boxShadow":"none","margin":"0","alignItems":"center","flexDirection":"column","display":"flex","clipPath":"polygon(25% 0%, 100% 0, 100% 100%, 0% 100%)","justifyContent":"center","borderRadius":"10px","background":"rgba(255,255,255,.92)","width":"55%","backgroundSize":"cover","backgroundPosition":"right bottom","backgroundRepeat":"no-repeat","height":"100vh"}'>
			<div v-if="true" :style='{"margin":"0 0 10px 0","color":"#3B2E7E","textAlign":"center","width":"80%","lineHeight":"44px","fontSize":"24px","textShadow":"none","fontWeight":"bold"}'>找回密码</p></div>
			<el-form-item :style='{"width":"550px","padding":"0","margin":"0 auto 15px","height":"auto"}' prop="username">
				<div v-if="true" :style='{"width":"100px","lineHeight":"44px","fontSize":"14px","position":"relative","color":"#3B2E7E"}'>账号：</div>
				<el-input v-model="forgetForm.username" placeholder="请您输入账号" />
			</el-form-item>
			<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","boxShadow":"none","margin":"20px auto 5px","color":"#fff","display":"block","outline":"none","borderRadius":"30px","background":"#3B2E7E","width":"550px","fontSize":"36px","height":"60px"}' type="primary" @click="getSecurity()">下一步</el-button>
		...
		<el-form class='rgs-form' v-if="pageFlag=='security2'" :style='{"padding":"20px 20px 20px 300px","boxShadow":"none","margin":"0","alignItems":"center","flexDirection":"column","display":"flex","clipPath":"polygon(25% 0%, 100% 0, 100% 100%, 0% 100%)","justifyContent":"center","borderRadius":"10px","background":"rgba(255,255,255,.92)","width":"55%","backgroundSize":"cover","backgroundPosition":"right bottom","backgroundRepeat":"no-repeat","height":"100vh"}'>
			<div v-if="true" :style='{"margin":"0 0 10px 0","color":"#3B2E7E","textAlign":"center","width":"80%","lineHeight":"44px","fontSize":"24px","textShadow":"none","fontWeight":"bold"}'>找回密码</p></div>
			<el-form-item :style='{"width":"550px","padding":"0","margin":"0 auto 15px","height":"auto"}' prop="pquestion">
				<div v-if="true" :style='{"width":"100px","lineHeight":"44px","fontSize":"14px","position":"relative","color":"#3B2E7E"}'>密保问题：</div>
				<el-input readonly v-model="registerForm.pquestion" placeholder="密保问题" />
			</el-form-item>
			<el-form-item :style='{"width":"550px","padding":"0","margin":"0 auto 15px","height":"auto"}' prop="myanswer">
				<div v-if="true" :style='{"width":"100px","lineHeight":"44px","fontSize":"14px","position":"relative","color":"#3B2E7E"}'>密保答案：</div>
				<el-input v-model="registerForm.myanswer" placeholder="请您输入密保答案" />
			</el-form-item>
			<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","boxShadow":"none","margin":"20px auto 5px","color":"#fff","display":"block","outline":"none","borderRadius":"30px","background":"#3B2E7E","width":"550px","fontSize":"36px","height":"60px"}' type="primary" @click="validateSecurity()">下一步</el-button>
			<router-link :style='{"cursor":"pointer","padding":"0 10%","color":"#9e9e9e","display":"inline-block","lineHeight":"3","fontSize":"12px","textDecoration":"none"}' to="/login">已有账户登录</router-link>
		</el-form>
        <el-form class='rgs-form' v-if="pageFlag=='security3'" :style='{"padding":"20px 20px 20px 300px","boxShadow":"none","margin":"0","alignItems":"center","flexDirection":"column","display":"flex","clipPath":"polygon(25% 0%, 100% 0, 100% 100%, 0% 100%)","justifyContent":"center","borderRadius":"10px","background":"rgba(255,255,255,.92)","width":"55%","backgroundSize":"cover","backgroundPosition":"right bottom","backgroundRepeat":"no-repeat","height":"100vh"}'>
			<div v-if="true" :style='{"margin":"0 0 10px 0","color":"#3B2E7E","textAlign":"center","width":"80%","lineHeight":"44px","fontSize":"24px","textShadow":"none","fontWeight":"bold"}'>找回密码</p></div>
			<el-form-item :style='{"width":"550px","padding":"0","margin":"0 auto 15px","height":"auto"}' prop="newpassword">
				<div v-if="true" :style='{"width":"100px","lineHeight":"44px","fontSize":"14px","position":"relative","color":"#3B2E7E"}'>新密码：</div>
				<el-input v-model="registerForm.newpassword" type="password" placeholder="请您输入新密码" />
			</el-form-item>
			<el-form-item :style='{"width":"550px","padding":"0","margin":"0 auto 15px","height":"auto"}' prop="repassword">
				<div v-if="true" :style='{"width":"100px","lineHeight":"44px","fontSize":"14px","position":"relative","color":"#3B2E7E"}'>确认密码：</div>
				<el-input v-model="registerForm.repassword" type="password" placeholder="请您确认密码" />
			</el-form-item>
			<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","boxShadow":"none","margin":"20px auto 5px","color":"#fff","display":"block","outline":"none","borderRadius":"30px","background":"#3B2E7E","width":"550px","fontSize":"36px","height":"60px"}' type="primary" @click="updatePassword()">修改密码</el-button>
			<router-link :style='{"cursor":"pointer","padding":"0 10%","color":"#9e9e9e","display":"inline-block","lineHeight":"3","fontSize":"12px","textDecoration":"none"}' to="/login">已有账户登录</router-link>
        </el-form>
		<el-form class='rgs-form' v-if="pageFlag=='register'" :style='{"padding":"20px 20px 20px 300px","boxShadow":"none","margin":"0","alignItems":"center","flexDirection":"column","display":"flex","clipPath":"polygon(25% 0%, 100% 0, 100% 100%, 0% 100%)","justifyContent":"center","borderRadius":"10px","background":"rgba(255,255,255,.92)","width":"55%","backgroundSize":"cover","backgroundPosition":"right bottom","backgroundRepeat":"no-repeat","height":"100vh"}' ref="registerForm" :model="registerForm" :rules="rules">
			...
			<div v-if="true" :style='{"margin":"0 0 10px 0","color":"#3B2E7E","textAlign":"center","width":"80%","lineHeight":"44px","fontSize":"24px","textShadow":"none","fontWeight":"bold"}'>基于Java的医院体检预约管理系统 设计与实现注册</p></div>
			<el-form-item :style='{"width":"550px","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yonghu'" prop="zhanghao">
				<div v-if="true" :style='{"width":"100px","lineHeight":"44px","fontSize":"14px","position":"relative","color":"#3B2E7E"}' :class="changeRules('zhanghao')?'required':''">账号：</div>
			...
			<el-form-item :style='{"width":"550px","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yonghu'" prop="xingming">
				<div v-if="true" :style='{"width":"100px","lineHeight":"44px","fontSize":"14px","position":"relative","color":"#3B2E7E"}' :class="changeRules('xingming')?'required':''">姓名：</div>
				<el-input v-model="registerForm.xingming"  placeholder="请输入姓名" />
			</el-form-item>
			<el-form-item :style='{"width":"550px","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yonghu'" prop="nianling">
				<div v-if="true" :style='{"width":"100px","lineHeight":"44px","fontSize":"14px","position":"relative","color":"#3B2E7E"}' :class="changeRules('nianling')?'required':''">年龄：</div>
			...
			<el-form-item :style='{"width":"550px","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yonghu'" prop="shouji">
				<div v-if="true" :style='{"width":"100px","lineHeight":"44px","fontSize":"14px","position":"relative","color":"#3B2E7E"}' :class="changeRules('shouji')?'required':''">手机：</div>
				<el-input v-model="registerForm.shouji"  placeholder="请输入手机" />
			</el-form-item>
			<el-form-item :style='{"width":"550px","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yonghu'" prop="shenfenzheng">
				<div v-if="true" :style='{"width":"100px","lineHeight":"44px","fontSize":"14px","position":"relative","color":"#3B2E7E"}' :class="changeRules('shenfenzheng')?'required':''">身份证：</div>
			...
			<el-form-item :style='{"width":"550px","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yonghu'" prop="pquestion">
				<div v-if="true" :style='{"width":"100px","lineHeight":"44px","fontSize":"14px","position":"relative","color":"#3B2E7E"}' :class="changeRules('pquestion')?'required':''">密保问题：</div>
				<el-input v-model="registerForm.pquestion"  placeholder="请输入密保问题" />
			</el-form-item>
			<el-form-item :style='{"width":"550px","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yonghu'" prop="panswer">
				<div v-if="true" :style='{"width":"100px","lineHeight":"44px","fontSize":"14px","position":"relative","color":"#3B2E7E"}' :class="changeRules('panswer')?'required':''">密保答案：</div>
