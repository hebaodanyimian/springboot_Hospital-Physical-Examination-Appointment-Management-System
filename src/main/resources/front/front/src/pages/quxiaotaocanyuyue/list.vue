...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"border":"1px solid #E0E0E0","padding":"10px","margin":"0 auto","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"calc(100% - 20px)","height":"auto"}'>
      ...
      <el-form-item :style='{"margin":"0 5px 10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","color":"#000","display":"inline-block"}'>套餐类型：</div>
        <el-input v-model="formSearch.taocanleixing" placeholder="套餐类型" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"margin":"0 5px 10px"}'>
	  ...
	  <el-button v-if="btnAuth('quxiaotaocanyuyue','新增')" :style='{"cursor":"pointer","border":"0","padding":"0px 15px","margin":"0 10px 10px 0","outline":"none","color":"#fff","borderRadius":"0","background":"#3B2E7E","width":"auto","fontSize":"14px","lineHeight":"42px","height":"42px"}' type="primary" @click="add('/index/quxiaotaocanyuyueAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
	...
	<div class="list" :style='{"width":"100%","padding":"20px 0","margin":"0 0 10px","background":"#fff"}'>
		...
		<div class="list1 index-pv1" :style='{"width":"100%","padding":"0 10px","flexWrap":"wrap","background":"#fff","display":"block","height":"auto"}'>
			<div :style='{"border":"1px solid #E0E0E0","padding":"45px 30px 15px","margin":"0","flexWrap":"wrap","background":"none","display":"inline-block","width":"25%","position":"relative","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box">
				...
				<div :style='{"width":"40%","padding":"10px 10px 0 ","textAlign":"center","display":"inline-block","order":"7"}'>
				  <span class="icon iconfont icon-geren16" :style='{"margin":"0 2px 0 0","lineHeight":"1.5","fontSize":"14px","color":"#909090"}'></span>
				  <span class="text" :style='{"color":"#909090","lineHeight":"1.5","fontSize":"14px"}'>{{item.zhanghao}}</span>
				</div>
			</div>
		</div>
  ...
  export default {
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        this.$http.get(`quxiaotaocanyuyue/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        ...
        this.$router.push({path: '/index/quxiaotaocanyuyueDetail', query: params});
      },
