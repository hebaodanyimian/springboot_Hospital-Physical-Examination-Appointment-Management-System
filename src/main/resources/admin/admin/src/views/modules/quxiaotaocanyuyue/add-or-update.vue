<template>
	<div class="addEdit-block" :style='{"width":"100%","padding":"0px 30px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'" label="取消编号" prop="quxiaobianhao">
					<el-input v-model="ruleForm.quxiaobianhao" placeholder="取消编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.quxiaobianhao" label="取消编号" prop="quxiaobianhao">
					<el-input v-model="ruleForm.quxiaobianhao" placeholder="取消编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="套餐类型" prop="taocanleixing">
					<el-input v-model="ruleForm.taocanleixing" placeholder="套餐类型" clearable  :readonly="ro.taocanleixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="套餐类型" prop="taocanleixing">
					<el-input v-model="ruleForm.taocanleixing" placeholder="套餐类型" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="取消原因" prop="quxiaoyuanyin">
					<el-input v-model="ruleForm.quxiaoyuanyin" placeholder="取消原因" clearable  :readonly="ro.quxiaoyuanyin"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="取消原因" prop="quxiaoyuanyin">
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `quxiaotaocanyuyue/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.quxiaotaocanyuyueCrossAddOrUpdateFlag = false;
											this.parent.search();
